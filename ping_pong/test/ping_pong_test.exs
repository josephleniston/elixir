defmodule PingPongTest do
  ...
  test "it responds ot a pong with a ping" do
    # spawn takes a module, a function name, and a list of arguemnts
    ...
    send(ping, {:pong, self()})
    # We'll assert that when we send a pong ot a process, we receive back a ping
